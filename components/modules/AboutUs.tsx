...
const MODULES = [
  ...
  { num: 4, name: "鋒兄重灌", category: "生活", desc: "Windows／Mac 重灌軟體清單，付費序號預設隱藏，可設查看密碼與訂閱週期／費用" },
...
const RELEASE_ITEMS = [
  {
    ...
    bullets: [
      ...
      "重灌軟體分 Windows／Mac，付費序號預設隱藏；可另設查看密碼，清單需先輸入才顯示序號。訂閱制可記下年／月週期與台幣／美元／日圓／人民幣費用。刪除前需確認，預設焦點在取消。",
