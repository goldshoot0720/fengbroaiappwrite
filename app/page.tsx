...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "image-voice-video", label: "圖片語音成片", icon: <Clapperboard size={18} /> },
      { id: "image-format-convert", label: "圖片格式轉換", icon: <Images size={18} /> },
      { id: "video-merge", label: "影片合併", icon: <Film size={18} /> },
      { id: "youtube-bilibili-convert", label: "YT / B站轉檔", icon: <Youtube size={18} /> },
    ],
  },
  {
    id: "settings-group",
