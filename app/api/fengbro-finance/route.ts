...
const INSTRUMENTS: FinanceInstrument[] = [
  ...
  { id: "sk-hynix-adr", name: "SK hynix Inc. ADR", symbol: "HXSCL", sourceUrl: "https://finance.yahoo.com/quote/HXSCL", group: "korea", provider: "yahoo" },
