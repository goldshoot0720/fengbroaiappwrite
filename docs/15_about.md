...
|---|---|---|
| 1 | 鋒兄首頁 | 系統入口與模組導覽 |
| 2 | 鋒兄儀表 | 跨模組統計、到期與媒體流量 |
| 3 | 鋒兄訂閱 | 訂閱、扣款日、CSV、本機垃圾桶 |
| 4 | 鋒兄食品 | 庫存、到期管理與批次清理 |
| 5 | 鋒兄筆記 | 快速筆記、附件與本機垃圾桶 |
| 6 | 鋒兄常用 | 常用入口、置頂與最近使用 |
| 7 | 鋒兄圖片 | 圖片整理與工作台摘要 |
| 8 | 鋒兄影片 | 影片播放與媒體管理 |
| 9 | 鋒兄音樂 | 音樂、歌詞與播放控制 |
| 10 | 鋒兄文件 | 文件預覽、分類與匯入匯出 |
| 11 | 鋒兄播客 | 節目、批次上傳與摘要管理 |
| 12 | 鋒兄銀行 | 帳戶、電子票證與餘額 |
| 13 | 鋒兄例行 | 例行任務與日期遞移 |
...
| 16 | 鋒兄比價 | 手動商品與價格紀錄 |
| 17 | 手機比價 | 地標網通 + 傑昇通信 |
| 18 | 圖片 + 語音 = 影片 | FFmpeg 合成 |
| 19 | PNG / JPEG 轉換 | 圖片格式轉換 |
| 20 | 影片合併 | 多段影片合併 |
| 21 | YT / B站轉 MP3/MP4 | 下載轉檔 |
| 22 | 鋒兄Tube | 頻道與倒台指數 |
| 23 | 鋒兄金融 | CNBC / Yahoo 報價 |
| 24 | 鋒兄新聞 | 鎖定網站焦點 |
